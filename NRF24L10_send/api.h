...
// Define SPI pins
sbit CE2   = P2^0;  // Chip Enable pin signal (output)
sbit CSN2  = P2^1;  // Slave Select pin, (output to CSN, nRF24L01)
sbit IRQ2  = P2^3;  // Interrupt signal, from nRF24L01 (input)
sbit MISO2 = P2^4;  // Master In, Slave Out pin (input)
sbit MOSI2 = P2^5;  // Serial Clock pin, (output)
sbit SCK2  = P2^7;  // Master Out, Slave In pin (output)

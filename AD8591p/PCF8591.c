...
uchar code Tab[]={0x00,0xfe,0xfd,0xfb,0xf7,0xef,0xdf,0xbf,0x7f};	   //数码管位选表
...
uchar idata receivebuf[4]={0x00,0x00,0x00,0x00};    //数据接收缓冲区
...
{
	//  dis[2]=val/26;   //AD值转换为3为BCD码，最大为5.00V。
...
void timer0() interrupt 1
{
	...
	if(iden==40)
{
		  dat[0]=show_value(0); //显示通道0
		  dat[1]=show_value(1); //显示通道1
		  dat[2]=show_value(2); //显示通道2
		  dat[3]=show_value(3); //显示通道3	
iden=0;	 	
} 
iden++;
	TH0=(65535-10000)/256;
